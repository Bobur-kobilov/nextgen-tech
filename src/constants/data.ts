...
export const TEAM_DATA = [
  ...
  },
  {
    ...
    department: "Engineering",
    image: "/api/placeholder/300/300",
    bio: "Infrastructure specialist with expertise in CI/CD, containerization, and cloud platforms.",
  ...
  },
  {
    ...
    department: "Engineering",
    image: "/api/placeholder/300/300",
    bio: "Versatile developer with strong skills in both frontend and backend technologies.",
  ...
  },
  {
    ...
    department: "Product",
    image: "/api/placeholder/300/300",
    bio: "Strategic product leader with experience in agile methodologies and user research.",
